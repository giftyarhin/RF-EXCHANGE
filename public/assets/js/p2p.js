...
function switchP2PTab(tab) {
  ...
  // Update tab buttons using data attributes
  const tabs = document.querySelectorAll('.p2p-tab');
  tabs.forEach((btn) => {
    const btnTab = btn.getAttribute('data-tab') || btn.textContent.toLowerCase().trim();
    if (btnTab === tab) {
      ...
      <form onsubmit="handleCreateAd(event)" style="display: grid; gap: 20px;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
          <div>
            ...
            <select name="crypto" required style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: #F1F5F9;">
          ...
          <div>
            ...
            <select name="fiat" required style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: #F1F5F9;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
          <div>
            ...
            <input name="price" type="number" step="0.01" required placeholder="e.g., 1480.50" style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: #F1F5F9;">
          ...
          <div>
            ...
            <input name="amount" type="number" step="0.01" required placeholder="e.g., 1000" style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: #F1F5F9;">
          </div>
        </div>
        ...
        <div>
          ...
          <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
            <input name="minLimit" type="number" required placeholder="Minimum (e.g., 50000)" style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: #F1F5F9;">
            <input name="maxLimit" type="number" required placeholder="Maximum (e.g., 500000)" style="width: 100%; padding: 12px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 8px; color: #F1F5F9;">
          </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
  // Set initial tab (this calls renderOffers internally)
  switchP2PTab('buy');
  ...
  // Add event delegation for trade buttons
  document.addEventListener('click', function(e) {
    if (e.target.classList.contains('trade-btn')) {
      const trader = e.target.getAttribute('data-trader');
      const type = e.target.getAttribute('data-type');
      if (trader && type) {
        startTrade(trader, type);
      }
    }
  });
});
